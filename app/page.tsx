...
import { counters, heroStats, reasons, services, valueProps } from "@/lib/data";
  ...
  return (
    <>
      <section className="relative overflow-hidden px-5 pb-20 pt-16 sm:px-6 lg:px-8 lg:pb-28 lg:pt-20">
        ...
        <div className="container-premium relative grid items-center gap-12 lg:grid-cols-[1fr_0.9fr]">
          <div>
            <MotionDiv
            ...
            >
              <p className="eyebrow">Creative freelance brand</p>
              <h1 className="mt-5 max-w-4xl text-5xl font-semibold tracking-tight text-ink sm:text-6xl lg:text-7xl">
                Designs That Build Attention
              </h1>
              <p className="mt-6 max-w-2xl text-lg leading-8 text-muted">
                Helping creators, businesses, and brands grow with modern design, editing, branding, and digital content solutions.
              </p>
      ...
      <section className="section-padding bg-white">
        <div className="container-premium">
          <SectionHeading
            eyebrow="Services"
            title="Creative support for every growth channel."
            description="From thumbnails and edits to full visual identity systems, each service is built to help your brand look sharp, clear, and ready to convert."
            align="center"
          />
          <div className="mt-14 grid gap-5 sm:grid-cols-2 lg:grid-cols-5">
            {services.map((service, index) => (
              <Reveal key={service.title} delay={index * 0.03} className="card-premium p-5">
                <service.icon size={24} className="text-royal" />
                <h3 className="mt-5 text-lg font-semibold text-ink">{service.title}</h3>
                <p className="mt-3 text-sm leading-6 text-muted">{service.description}</p>
                <p className="mt-5 text-sm font-bold text-ink">Starts at {service.price}</p>
              </Reveal>
            ))}
          </div>
        </div>
        ...
        <div className="container-premium">
          <div className="grid gap-12 lg:grid-cols-[0.8fr_1fr] lg:items-start">
            <SectionHeading
              ...
              title="Trust-building design that understands attention."
              description="Professional design is not only about looking good. It needs to guide the viewer, support your offer, and fit the platform where your audience spends time."
            />
